         ...
         if(mysqli_stmt_num_rows($stmt) == 1){
             ...
             if(mysqli_stmt_fetch($stmt)){
                 if(password_verify($password, $hashed_password)){
                     //this means the pwd is correct. Allow user to login
                     session_start();
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/cse/img/faculties/14.png" alt="">
    <h3 class="price">CSE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">BANSARI PATEL</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/cse/img/faculties/16.png" alt="">
    <h3 class="price">CSE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">BRIJESH PANCHAL</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/ce/img/faculties/9.png" alt="">
    <h3 class="price">CE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">BINAL KAKA</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/ce/img/faculties/8.png" alt="">
    <h3 class="price">CE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">BHAVIKA PATEL</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/ce/img/faculties/4.png" alt="">
    <h3 class="price">CE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">DR. CHIRAG PATEL</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/it/img/faculties/6.png" alt="">
    <h3 class="price">IT</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">CHINTAL RAVAL</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/cse/img/faculties/8.png" alt="">
    <h3 class="price">CSE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">CHANDRASHEKHAR PAWAR</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/ce/img/faculties/2.png" alt="">
    <h3 class="price">CE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">DR. DWEEPNA GARG</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/cse/img/faculties/5.png" alt="">
    <h3 class="price">CSE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">DIPAK RAMOLIYA</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/ce/img/faculties/11.png" alt="">
    <h3 class="price">CE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">DHRUVI GOSAI</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/it/img/faculties/3.png" alt="">
    <h3 class="price">IT</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">HARDIK JAISWAL</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/cse/img/faculties/13.png" alt="">
    <h3 class="price">CSE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">GAURANG PATEL</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/cse/img/faculties/9.png" alt="">
    <h3 class="price">CSE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">HARSHIL JOSHI</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/ce/img/faculties/10.png" alt="">
    <h3 class="price">CE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">JANARDAN BHARVAD</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/cse/img/faculties/4.png" alt="">
    <h3 class="price">CSE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">JESAL DESAI</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/ce/img/faculties/6.png" alt="">
    <h3 class="price">CE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">KHUSHI PATEL</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/cse/img/faculties/6.png" alt="">
    <h3 class="price">CSE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">KRISHNA PATEL</a>
    <p>
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/ce/img/faculties/3.png" alt="">
    <h3 class="price">CE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">DR. MINAL PATEL</a>
    <p>
        Data communications are the exchange of data between two devices via some form of transmission medium such as a wire cable.
        For data communications to occur, the communicating devices must be part of a communication system made up of a combination of hardware (physical equipment) and software (programs).
...
<div class="box">
    <img src="https://www.charusat.ac.in/depstar/ce/img/faculties/5.png" alt="">
    <h3 class="price">CE</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">MOHAMMED BOHRA</a>
    <p>
        Data communications are the exchange of data between two devices via some form of transmission medium such as a wire cable.
        For data communications to occur, the communicating devices must be part of a communication system made up of a combination of hardware (physical equipment) and software (programs).
...
<div class="box">
    <img src="https://charusat.ac.in/pdpias/maths-dept/img/maths/faculties/Ms.%20Niru%20Patel.jpg" alt="">
    <h3 class="price">Math</h3>
    <div class="content">
        <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
        ...
        <a href="#" class="title">NIRU PATEL</a>
    <p>
        Data communications are the exchange of data between two devices via some form of transmission medium such as a wire cable.
        For data communications to occur, the communicating devices must be part of a communication system made up of a combination of hardware (physical equipment) and software (programs).
